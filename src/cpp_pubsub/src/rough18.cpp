...
public:
    gps_controller_cin() : Node("gps_controller_cin")
    {
        ...
        arm_cmd_pub_ = create_publisher<geometry_msgs::msg::Twist>("/cmd_vel2", 10);  // Fixed typo
...
private:
    ...
    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr arm_cmd_pub_;  // Fixed typo
    ...
    void drop_object()
    {
        ...
        // Publish gripper open command for 12 seconds
